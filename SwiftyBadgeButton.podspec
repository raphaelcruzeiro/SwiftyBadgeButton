#
#  Be sure to run `pod spec lint SwiftyBadgeButton.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "SwiftyBadgeButton"
  s.version      = "0.9.0"
  s.summary      = "A simple, 100% Swift and fully tested badge button."
  ...
  s.source       = { :git => "https://github.com/raphaelcruzeiro/SwiftyBadgeButton.git", :tag => "0.9.0" }
  ...
  s.source_files  = "SwiftyBadgeButton"
